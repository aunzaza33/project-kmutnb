...
app.post('/repairs', (req, res) => {
  ...
  const { durablearticles_Id, room, repair_detail, Informer,repair_img } = req.body;
  ...
  const values = [durablearticles_Id, room, repair_detail, Informer, repair_status, repair_durablearticles_date,repair_img];
